...
If you don't have the permission to do this, set [limitOpenFilesOnRemote](https://github.com/jmwerk/vscode-sftp/wiki#limitopenfilesonremote) option in your config.
